...
button3 = Button(mainwindow,text = "Click Me 3",command = sayHelloWorld).grid(row=2,column=1)
label = Label(mainwindow,text = "Hello World",width=20,fg="red",bg="black").grid(row=0,column=0)
